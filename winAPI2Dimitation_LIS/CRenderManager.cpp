...
void CRenderManager::RenderImage(CD2DImage* img, float dstX, float dstY, float dstW, float dstH, float alpha, Vec2 pos, float angle)
{
...
void CRenderManager::RenderRectangle(float dstX, float dstY, float dstW, float dstH, COLORREF color, Vec2 pos, float angle)
{
...
void CRenderManager::RenderFillRectangle(float dstX, float dstY, float dstW, float dstH, COLORREF color, float alpha, Vec2 pos, float angle)
{
	D2D1_RECT_F m_imgRect = { dstX, dstY, dstW, dstH };
...
void CRenderManager::RenderEllipse(float dstX, float dstY, float dstW, float dstH, COLORREF color, Vec2 pos, float angle)
{
...
void CRenderManager::RenderFillEllipse(float dstX, float dstY, float dstW, float dstH, COLORREF color, Vec2 pos, float angle)
{
	D2D1_ELLIPSE m_imgRect = { dstX, dstY, dstW, dstH };
...
void CRenderManager::RenderLine(Vec2 startPoint, Vec2 endPoint, COLORREF color, float strokeWidth, Vec2 pos, float angle)
{
